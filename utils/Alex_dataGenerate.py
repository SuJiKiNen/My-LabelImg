...
class ImageDataGenerator(object):
    ...
    def __init__(self, txt_file, mode, batch_size, num_classes, img_size,shuffle=True,
                 buffer_size=1000):
        ...
        # create a new dataset with batches of plotimages
    ...
    def _parse_function_train(self, filename, label):
        ...
        img_resized = tf.image.resize_images(img_decoded, [self.img_size, self.img_size])
        """
